...
This toolkit contains three sample programs based on tello sdk and **python3.6**, including Single_Tello_Test, Tello_Video, and Tello_Video (With_Pose_Recognition). There is also a program file named tello_state.py.
